...
namespace AmicusAPI.Controllers
{
    ...
    public class CustomerRoleController : ControllerBase
    {
        ...
        //[HttpPatch]
        //public async Task<IActionResult> Patch( string key, Delta<CustomerRoleDto> model)
        //{
        //    if (!await _permissionService.Authorize(PermissionSystemName.Customers))
        //        return Forbid();
